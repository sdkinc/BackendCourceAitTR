...
public class EventServiceTest {
  ...
  public void testAddEvent(){
    EventDTO eventDTOin = new EventDTO(null,EventDTOTest.NAME,EventDTOTest.CITY);
    ...
    City city = cityRepository.findByName(EventDTOTest.CITY);
    Assertions.assertNotNull(event);
    Assertions.assertEquals(EventDTOTest.NAME,event.getName());
    Assertions.assertEquals(event.getCity().getCityId(),city.getCityId());

    Assertions.assertNotNull(city);
    Assertions.assertEquals(EventDTOTest.CITY,event.getCity().getName());
